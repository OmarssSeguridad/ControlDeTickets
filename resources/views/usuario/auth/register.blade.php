                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/usuario/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('cargo') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('telefono') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="telefono" type="number" class="form-control" name="telefono" value="{{ old('departamento') }}">
                        ...
                        <div class="form-group{{ $errors->has('sucursal') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="sucursal" type="text" class="form-control" name="sucursal" value="{{ old('sucursal') }}">
                        ...
                        <div class="form-group{{ $errors->has('noEmpleado') ? ' has-error' : '' }}">
                            <label for="noEmpleado" class="col-md-4 control-label">No. Empleado</label>

                            <div class="col-md-6">
                                <input id="noEmpleado" type="noEmpleado" class="form-control" name="noEmpleado" value="{{ old('noEmpleado') }}">

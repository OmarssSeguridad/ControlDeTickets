                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    <h4 class="card-title">Tabla de Cargos</h4>
                                    <p class="card-category">Cargos Activos</p>
                                </div>
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{ $cargo->name }}</td>
                                                <td> 
                                                 <form action="{{'/admin/editaCargo/'.$cargo->id}}" method="PUT">
                                                    {{ csrf_field() }}
                                                    {{ method_field('PUT') }}
                                                    <button type="submit"class="btn btn-info btn-fill pull-right"><i class="fa fa-edit"></i></button>
                                                </form>
                                                <form action="{{'/admin/bajaCargo/'.$cargo->id}}" method="post"> 
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
